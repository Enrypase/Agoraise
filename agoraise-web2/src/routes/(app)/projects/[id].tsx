...
export default function Project() {
  ...
  return (
    <div class="min-h-screen p-5">
            ...
            <div class="flex flex-wrap gap-2">
              ...
              <div class="flex grow flex-col gap-2">
                ...
                <div class="flex justify-between rounded-xl rounded-tl-none bg-main p-5 text-white">
                  <p>Project Type</p>
                  <small class="font-bold">Charity</small>
                </div>
              </div>
            ...
            <div class="overflow-hidden rounded-xl shadow-xl">
              ...
              <div class="relative flex flex-col gap-5 p-10">
                ...
                <div class="flex gap-2">
                  <p class="rounded-xl bg-blue px-2 py-1 text-white">TAG 1</p>
                  <p class="rounded-xl bg-blue px-2 py-1 text-white">TAG 2</p>
                </div>
      ...
      <Votations title={data.metadata.title} />
    </div>
  );
}
